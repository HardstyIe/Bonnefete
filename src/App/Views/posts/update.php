...
<div class="w-full max-w-3xl h-screen rounded-lg p-8 create-form">
  <form class="flex flex-col items-center w-full p-8 mx-auto bg-white border-2 border-gray-300 post-create" action="../../post/update/<?php echo $post[0]['id']; ?>" method="post" enctype="multipart/form-data">
    ...
    <textarea name="article" id="article" cols="30" rows="10" maxlength="200" required class="block w-full max-w-2xl p-2 mb-4  border-gray-300 rounded-lg bg-gray-300 focus:outline-none focus:border-gray-500"></textarea>
    ...
    <div class="w-full flex flex-col">
      ...
      <img id="imagePreview" src="#" alt="Aperçu de l'image" style="max-width: 150px; display: none;">
    </div>
